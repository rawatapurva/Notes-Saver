...
const Home = () => {
  ...
  const createPaste = () => {
    if (!value.trim()) {
      toast.error("You have to write something to create a paste", {
        position: "top-right",
      });
      return;
    }
      ...
      <div className="flex flex-col gap-y-5 items-start">
        <div className="w-full flex flex-row gap-x-4 justify-between items-center">
          <input
            ...
            className={`${
              pasteId ? "w-[80%]" : "w-[85%]"
            } text-black border-2 border-input rounded-md p-2`}
          />
          <button
        ...
        >
          ...
          <textarea
            ...
            className="w-full p-3  focus-visible:ring-0 border-2 border-black"
            style={{
              caretColor: "#000",
            }}
            rows={20}
